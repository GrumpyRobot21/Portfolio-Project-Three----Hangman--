...
#     print ("carefully select letters in the vain hope\n of avoiding the")        
#     print ("gallows by guessing the word before it's too late!\n Can you cheat the hangmans noose in time?  Find out....if you dare!\n")
...
#         Colortext.RED
#         + Colortext.BOLD
#         + " Select your difficulty level from the choices below and the challenge will \n begin. See you at the end .......of the rope! \n\n Enter"
#         + Colortext.BLUE
#         + Colortext.BOLD
#         + " '1' "
#         + Colortext.RED
...
#     used = (
#         set()
#     )  # creates and references a set of the letters that have been used in the game
#     player_life = str(
#         lives
#     )  # defines a game variable making a string out of the lives remaining/ chosen through difficulty level

#     print(
#         Colortext.GREEN
#         + Colortext.BOLD
#         + " Now we get to test your nerve!!! Guess the word and escape\n the noose this day.......!"
#     )
#     print(
#         "\n You have",
#         lives,
...
#         ]  # Comprehension substitutes dashes for the letters and checks to see if letters have been used.
#         print(
#             Colortext.GREEN
#             + Colortext.BOLD
...
#         elif (
#             user_guess in used
#         ):  # When user chooses letter already used and identified as being in the used set
#             print(
#                 Colortext.YELLOW
#                 + Colortext.BOLD
